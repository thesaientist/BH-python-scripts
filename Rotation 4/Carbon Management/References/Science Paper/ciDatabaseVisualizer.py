...
# cidf.to_pickle('CIDB.pkl')

# load CI database dataframe from pickle file
cidf = pd.read_pickle('CIDB.pkl')

# define subsets for useful comparisons and plots
df = cidf.dropna(subset=['Basin'])
offshoreDF = df[df['On/Offshore']=='Offshore']
...
# ----------------------------------------------------------------------------
# PLOT1A: archetypes CI distribution comparison (excluding outliers)
...
# PLOT1B: archetypes CI averages breakdown
